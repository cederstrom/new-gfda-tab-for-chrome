...
function showNewAdvice() {
    var randomIndex;
    var currentIndex = parseInt(document.getElementById("advice-number").innerHTML);
    ...
    var newAdvice = advices[randomIndex];
    document.getElementById("advice-number").innerHTML = newAdvice[0];
    document.getElementById("advice-text").innerHTML = newAdvice[1];
}

showNewAdvice();

document.getElementById("more-advice").addEventListener('click', function() {
    showNewAdvice()
}, false);
